  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to EduForge! Let's start your learning journey.",
      });
      // Here you would redirect to onboarding or dashboard after successful signup
    }, 1500);
  };
        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-lg">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-2 pt-2">
                ...
                >
                  I agree to the{" "}
                  <Link to="/terms" className="text-eduforge-600 hover:text-eduforge-700 underline">
                    terms of service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-eduforge-600 hover:text-eduforge-700 underline">
                    privacy policy
                  </Link>
                  .
                </label>
              ...
              <Button 
                type="submit" 
                className="w-full bg-eduforge-600 hover:bg-eduforge-700" 
                disabled={isLoading}
              >
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/login" className="text-eduforge-600 hover:text-eduforge-700 font-medium">
                Sign in
              </Link>
            </p>
          </CardFooter>
